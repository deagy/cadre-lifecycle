...
export interface AgentExtensionCommand {
    name: string;
    description?: string;
    handler?: (input: string) => Promise<AgentExtensionCommandResult> | AgentExtensionCommandResult;
}
export type AgentExtensionCommandResult = string | {
    reply?: string;
    submitPrompt?: string;
};
...
export type AgentExtensionMcpEnv = Record<string, string | AgentExtensionMcpEnvValue>;
...
export type AgentExtensionMcpTransport = AgentExtensionMcpStdioTransport | AgentExtensionMcpSseTransport | AgentExtensionMcpStreamableHttpTransport;
...
declare const ExtensionCapabilityOptions: readonly ["hooks", "tools", "commands", "rules", "skills", "messageBuilders", "providers", "automationEvents", "mcp"];
...
export declare class ContributionRegistry<TExtension extends ContributionRegistryExtension<TTool, TMessage>, TTool = AgentTool, TMessage = unknown> {
    ...
    resolve(): void;
    validate(): void;
    setup(options?: ContributionRegistryInitializeOptions): Promise<void>;
    activate(): void;
    initialize(options?: ContributionRegistryInitializeOptions): Promise<void>;
    isActivated(): boolean;

...
export declare function shouldApplyPromptCache(request: GatewayStreamRequest, context: GatewayProviderContext): boolean;
export declare function resolvePromptCacheRoute(request: GatewayStreamRequest, context: GatewayProviderContext): GatewayModelRoute | undefined;
export declare function resolveReasoningRoute(request: GatewayStreamRequest, context: GatewayProviderContext): GatewayModelRoute | undefined;

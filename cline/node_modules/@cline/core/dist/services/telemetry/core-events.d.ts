import { type CaptureAgentUnexpectedReasoningTokensInput, captureAgentUnexpectedReasoningTokens, type ITelemetryService, type TelemetryProperties } from "@cline/shared";
import type { CoreCompactionBudgetPolicyIntent, CoreCompactionLiveTailHandling } from "../../types/config";
...
export declare const CORE_TELEMETRY_EVENTS: {
    ...
    readonly AGENT: {
        readonly UNEXPECTED_REASONING_TOKENS: "agent.reasoning.unexpected_tokens";
    };
    readonly USER: {
    ...
    readonly TASK: {
        ...
        readonly MISTAKE_LIMIT_REACHED: "task.mistake_limit_reached";
        ...
        readonly COMPACTION_BUDGET_EMERGENCY: "task.compaction_budget_emergency";
    };
    readonly HOOKS: {
...
export { captureAgentUnexpectedReasoningTokens, type CaptureAgentUnexpectedReasoningTokensInput, };
...
export declare function captureAuthLoggedOut(telemetry: ITelemetryService | undefined, provider?: string, reason?: string, details?: {
    status?: number;
    errorCode?: string;
}): void;
/**
 ...
 * production.
 */
export declare function captureAuthRefreshSoftFailure(telemetry: ITelemetryService | undefined, provider?: string, details?: {
    status?: number;
    errorCode?: string;
    errorName?: string;
 ...
 */
export declare function captureMistakeLimitReached(telemetry: ITelemetryService | undefined, properties: {
    ulid: string;
    model: string;
    provider?: string;

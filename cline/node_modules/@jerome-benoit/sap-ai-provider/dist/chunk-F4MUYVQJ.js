...
var require_array = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/array.js"(exports) {
    "use strict";
...
// node_modules/@sap-cloud-sdk/util/dist/string.js
var require_string = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/string.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function trim2(string) {
      return trimRight2(trimLeft2(string));
    }
...
// node_modules/@sap-cloud-sdk/util/dist/code-block.js
var require_code_block = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/code-block.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
`;
      ...
      const post = args.map((arg, i) => ("" + arg).split("\n").map((subArg) => indents[i] + subArg).join("\n"));
...
function parse(dateStr, format2, i18n) {
  ...
  for (var i = 1; i < matches2.length; i++) {
    ...
    var value = parser ? parser(matches2[i], combinedI18nSettings) : +matches2[i];
    if (value == null) {
      return null;
    }
...
var require_index_cjs = __commonJS({
  "node_modules/@so-ric/colorspace/dist/index.cjs.js"(exports, module) {
    ...
    function colorspace(namespace, delimiter) {
      ...
      let base2 = hex(split2[0]);
      if (!split2.length) return base2;
      for (let i = 0, l = split2.length - 1; i < l; i++) {
...
// node_modules/@sap-cloud-sdk/util/dist/logger/format/local.js
var require_local = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/logger/format/local.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.local = combine(errors({ stack: true }), timestamp(), (0, winston_1.format)(localTransformer)(), cli(), printf((info) => {
      const messageContext = info.custom_fields && typeof info.custom_fields === "object" && "messageContext" in info.custom_fields ? `${(0, node_util_1.styleText)("blue", `(${info.custom_fields.messageContext})`)}: ` : "";
      const message = typeof info.message === "string" ? info.message : "";
      const trimmedMessage = message.replace(/^\s*/, "");
      const paddingLength = message.length - trimmedMessage.length + messageContext.length;
      if (info.error) {
        info.level = (0, node_util_1.styleText)("inverse", info.level);
      }
      return `${(0, node_util_1.styleText)("gray", `[${info.timestamp}]`)} ${info.level} ${messageContext.padStart(paddingLength, " ")}${trimmedMessage}`;
    }));
    function getMessageOrStack(info) {
      const isString2 = (value) => typeof value === "string";
      const hasStackTrace = info.stack && info.level === "error";
      if (hasStackTrace && isString2(info.stack)) {
        return info.stack;
      }
      if (isString2(info.message)) {
        return info.message;
      }
      return "";
    }
...
// node_modules/@sap-cloud-sdk/util/dist/logger/format/kibana.js
var require_kibana = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/logger/format/kibana.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.kibana = void 0;
    var winston_1 = require_winston();
    var local_1 = require_local();
    var { combine, timestamp, json, errors } = winston_1.format;
...
// node_modules/@sap-cloud-sdk/util/dist/logger/format/index.js
var require_format2 = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/logger/format/index.js"(exports) {
    "use strict";
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    __exportStar(require_kibana(), exports);
    __exportStar(require_local(), exports);
  }
});

// node_modules/@sap-cloud-sdk/util/dist/logger/cloud-sdk-logger.js
var require_cloud_sdk_logger = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/logger/cloud-sdk-logger.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function setGlobalTransports(customTransports) {
      ...
      container.loggers.forEach((logger) => {
        logger.clear();
        return Array.isArray(customTransports) ? customTransports.forEach((transport) => logger.add(transport)) : logger.add(customTransports);
      });
    }
    function setLogFormat(format2, messageContextOrLogger = DEFAULT_LOGGER__MESSAGE_CONTEXT) {
      const messageContext = typeof messageContextOrLogger === "string" ? messageContextOrLogger : getMessageContext(messageContextOrLogger);
      if (messageContext) {
        customLogFormats[messageContext] = format2;
        if (container.has(messageContext)) {
          const logger = container.get(messageContext);
          logger.format = format2;
        }
      } else if (typeof messageContextOrLogger !== "string") {
        moduleLogger.warn("Setting log format for logger with unknown message context");
        messageContextOrLogger.format = format2;
      }
    }
    function setGlobalLogFormat(format2) {
      container.options.format = format2;
      container.loggers.forEach((logger) => {
        logger.format = format2;
      });
    }
...
// node_modules/@sap-cloud-sdk/util/dist/logger/index.js
var require_logger2 = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/logger/index.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? (function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    __exportStar(require_cloud_sdk_logger(), exports);
    __exportStar(require_format2(), exports);
  }
});

// node_modules/@sap-cloud-sdk/util/dist/documentation-block.js
var require_documentation_block = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/documentation-block.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@sap-cloud-sdk/util/dist/nullish.js
var require_nullish = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/nullish.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@sap-cloud-sdk/util/dist/equal.js
var require_equal = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/equal.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@sap-cloud-sdk/util/dist/error-with-cause.js
var require_error_with_cause = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/error-with-cause.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ErrorWithCause = void 0;
    exports.isErrorWithCause = isErrorWithCause2;
    var logger_1 = require_logger2();
...
${cause.stack}`;
       ...
       */
      get rootCause() {
        return isErrorWithCause2(this.cause) ? this.cause.rootCause : this.cause;
      }
    };
    exports.ErrorWithCause = ErrorWithCause;
    function isErrorWithCause2(err) {
      return err?.name === "ErrorWithCause";
    }
  }
});

// node_modules/@sap-cloud-sdk/util/dist/fs.js
var require_fs = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/fs.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@sap-cloud-sdk/util/dist/object.js
var require_object = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/object.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@sap-cloud-sdk/util/dist/pipe.js
var require_pipe = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/pipe.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@sap-cloud-sdk/util/dist/promise.js
var require_promise = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/promise.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@sap-cloud-sdk/util/dist/remove-slashes.js
var require_remove_slashes = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/remove-slashes.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
function wordToCamel(word2, index) {
  return index === 0 ? lowerCase(word2) : capitalize(word2, true);
}
...
function titleCase(subject, noSplit) {
  ...
  return subjectString.replace(wordsRegExp, function(word2, index) {
    var isNoSplit = index > 0 && noSplitArray.indexOf(subjectString[index - 1]) >= 0;
    return isNoSplit ? word2.toLowerCase() : capitalize(word2, true);
  });
}
...
function prune(subject, length, end) {
  ...
  subjectString.replace(pattern, function(word2, offset) {
    var wordInsertLength = offset + word2.length;
...
function padLeft(subject, length, pad3) {
  var subjectString = coerceToString(subject);
  var lengthInt = isNil(length) ? 0 : clipNumber(toInteger(length), 0, MAX_SAFE_INTEGER);
  var padString = coerceToString(pad3, " ");
  if (lengthInt <= subjectString.length) {
    return subjectString;
  }
  return buildPadding(padString, lengthInt - subjectString.length) + subjectString;
}
function padRight(subject, length, pad3) {
  var subjectString = coerceToString(subject);
  var lengthInt = isNil(length) ? 0 : clipNumber(toInteger(length), 0, MAX_SAFE_INTEGER);
  var padString = coerceToString(pad3, " ");
  if (lengthInt <= subjectString.length) {
...
function sprintf(format2) {
  var formatString = coerceToString(format2);
  if (formatString === "") {
    return formatString;
  }
...
function vprintf(format2, replacements) {
  return sprintf.apply(void 0, [format2].concat(_toConsumableArray(nilDefault(replacements, []))));
}
...
function pad2(subject, length, pad3) {
  var subjectString = coerceToString(subject);
  var lengthInt = isNil(length) ? 0 : clipNumber(toInteger(length), 0, MAX_SAFE_INTEGER);
  var padString = coerceToString(pad3, " ");
  if (lengthInt <= subjectString.length) {
...
var digit, whitespace, highSurrogate, lowSurrogate, diacriticalMark, base, REGEXP_COMBINING_MARKS, REGEXP_SURROGATE_PAIRS, REGEXP_UNICODE_CHARACTER, REGEXP_WHITESPACE, REGEXP_TRIM_LEFT, REGEXP_TRIM_RIGHT, REGEXP_DIGIT, REGEXP_SPECIAL_CHARACTERS, REGEXP_NON_LATIN, REGEXP_HTML_SPECIAL_CHARACTERS, REGEXP_CONVERSION_SPECIFICATION, REGEXP_TRAILING_ZEROS, REGEXP_TAG_LIST, generalPunctuationBlock, nonCharacter, dingbatBlock, lowerCaseLetter, upperCaseLetter, REGEXP_WORD, REGEXP_LATIN_WORD, REGEXP_ALPHA, REGEXP_ALPHA_DIGIT, REGEXP_EXTENDED_ASCII, MAX_SAFE_INTEGER, HIGH_SURROGATE_START, HIGH_SURROGATE_END, LOW_SURROGATE_START, LOW_SURROGATE_END, reduce, TYPE_INTEGER, TYPE_INTEGER_BINARY, TYPE_INTEGER_ASCII_CHARACTER, TYPE_INTEGER_DECIMAL, TYPE_INTEGER_OCTAL, TYPE_INTEGER_UNSIGNED_DECIMAL, TYPE_INTEGER_HEXADECIMAL, TYPE_INTEGER_HEXADECIMAL_UPPERCASE, TYPE_FLOAT_SCIENTIFIC, TYPE_FLOAT_SCIENTIFIC_UPPERCASE, TYPE_FLOAT, TYPE_FLOAT_SHORT, TYPE_FLOAT_SHORT_UPPERCASE, TYPE_STRING, LITERAL_SINGLE_QUOTE, LITERAL_PLUS, LITERAL_MINUS, LITERAL_PERCENT_SPECIFIER, RADIX_BINARY, RADIX_OCTAL, RADIX_HEXADECIMAL, escapeCharactersMap, unescapeCharactersMap, characters, diacritics, diacriticsMap, reduce$1, reduceRight, OPTION_WIDTH, OPTION_NEW_LINE, OPTION_INDENT, OPTION_CUT, BYRE_ORDER_MARK, STATE_START_TAG, STATE_NON_WHITESPACE, STATE_DONE, STATE_OUTPUT, STATE_HTML, STATE_EXCLAMATION, STATE_COMMENT, globalObject, globalObject$1, previousV, version, functions, es_default;
var init_es = __esm({
  "node_modules/voca/es/index.js"() {
    "use strict";
    digit = "\\d";
    ...
    highSurrogate = "\\uD800-\\uDBFF";
    lowSurrogate = "\\uDC00-\\uDFFF";
    diacriticalMark = "\\u0300-\\u036F\\u1AB0-\\u1AFF\\u1DC0-\\u1DFF\\u20D0-\\u20FF\\uFE20-\\uFE2F";
    base = "\\0-\\u02FF\\u0370-\\u1AAF\\u1B00-\\u1DBF\\u1E00-\\u20CF\\u2100-\\uD7FF\\uE000-\\uFE1F\\uFE30-\\uFFFF";
    REGEXP_COMBINING_MARKS = new RegExp("([" + base + "]|[" + highSurrogate + "][" + lowSurrogate + "]|[" + highSurrogate + "](?![" + lowSurrogate + "])|(?:[^" + highSurrogate + "]|^)[" + lowSurrogate + "])([" + diacriticalMark + "]+)", "g");
    REGEXP_SURROGATE_PAIRS = new RegExp("([" + highSurrogate + "])([" + lowSurrogate + "])", "g");
    REGEXP_UNICODE_CHARACTER = new RegExp("((?:[" + base + "]|[" + highSurrogate + "][" + lowSurrogate + "]|[" + highSurrogate + "](?![" + lowSurrogate + "])|(?:[^" + highSurrogate + "]|^)[" + lowSurrogate + "])(?:[" + diacriticalMark + "]+))|([" + highSurrogate + "][" + lowSurrogate + "])|([\\n\\r\\u2028\\u2029])|(.)", "g");
    ...
    REGEXP_CONVERSION_SPECIFICATION = /(%{1,2})(?:(\d+)\$)?(\+)?([ 0]|'.{1})?(-)?(\d+)?(?:\.(\d+))?([bcdiouxXeEfgGs])?/g;
    ...
    REGEXP_WORD = new RegExp("(?:[" + upperCaseLetter + "][" + diacriticalMark + "]*)?(?:[" + lowerCaseLetter + "][" + diacriticalMark + "]*)+|(?:[" + upperCaseLetter + "][" + diacriticalMark + "]*)+(?![" + lowerCaseLetter + "])|[" + digit + "]+|[" + dingbatBlock + "]|[^" + nonCharacter + generalPunctuationBlock + whitespace + "]+", "g");
    REGEXP_LATIN_WORD = /[A-Z\xC0-\xD6\xD8-\xDE]?[a-z\xDF-\xF6\xF8-\xFF]+|[A-Z\xC0-\xD6\xD8-\xDE]+(?![a-z\xDF-\xF6\xF8-\xFF])|\d+/g;
    REGEXP_ALPHA = new RegExp("^(?:[" + lowerCaseLetter + upperCaseLetter + "][" + diacriticalMark + "]*)+$");
    REGEXP_ALPHA_DIGIT = new RegExp("^((?:[" + lowerCaseLetter + upperCaseLetter + "][" + diacriticalMark + "]*)|[" + digit + "])+$");
    ...
    diacriticsMap = null;
    reduce$1 = Array.prototype.reduce;
    ...
    STATE_COMMENT = 3;
    globalObject = null;
    globalObject$1 = getGlobalObject();
    previousV = globalObject$1.v;
    version = "1.4.0";
    functions = {
      camelCase,
      capitalize,
...
// node_modules/@sap-cloud-sdk/util/dist/string-formatter.js
var require_string_formatter = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/string-formatter.js"(exports) {
    "use strict";
    ...
    exports.kebabCase = kebabCase2;
    exports.formatJson = formatJson;
    var voca_1 = __importDefault((init_es(), __toCommonJS(es_exports)));
    exports.unixEOL = "\n";
    exports.webEOL = "\r\n";
    ...
    function pascalCase(str) {
      return voca_1.default.words(str).map((word2) => voca_1.default.capitalize(word2)).join("");
    }
...
// node_modules/@sap-cloud-sdk/util/dist/types.js
var require_types = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/types.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.caps = caps;
...
// node_modules/@sap-cloud-sdk/util/dist/unique-name-generator.js
var require_unique_name_generator = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/unique-name-generator.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/@sap-cloud-sdk/util/dist/url.js
var require_url = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/url.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_dist = __commonJS({
  "node_modules/@sap-cloud-sdk/util/dist/index.js"(exports) {
    ...
    __exportStar(require_code_block(), exports);
    __exportStar(require_documentation_block(), exports);
    __exportStar(require_equal(), exports);
    __exportStar(require_error_with_cause(), exports);
    __exportStar(require_fs(), exports);
    __exportStar(require_logger2(), exports);
    __exportStar(require_nullish(), exports);
    __exportStar(require_object(), exports);
    __exportStar(require_pipe(), exports);
    __exportStar(require_promise(), exports);
    __exportStar(require_remove_slashes(), exports);
    __exportStar(require_string(), exports);
    __exportStar(require_string_formatter(), exports);
    __exportStar(require_types(), exports);
    __exportStar(require_unique_name_generator(), exports);
    __exportStar(require_url(), exports);
  }
});

// src/sap-ai-provider-options.ts
...
var embeddingModelParamsSchema = z.object({
...
var promptTemplateRefByScenarioNameVersionSchema = z.object({
...
var promptTemplateRefSchema = z.union([
...
var sapAIEmbeddingProviderOptions = lazySchema(
  () => zodSchema(
    z.object({
      api: sapAIApiTypeSchema.optional(),
...
function extractModelIdentifier(message, location) {
  ...
  for (const pattern of patterns) {
    const match2 = pattern.exec(message);
    if (match2?.[1]) {
      return match2[1];
    }
  }

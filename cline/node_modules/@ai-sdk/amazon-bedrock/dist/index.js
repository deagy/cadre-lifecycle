...
var BedrockToolUseSchema = import_v44.z.object({
  ...
  input: import_v44.z.unknown().optional()
});
...
var BedrockResponseSchema = import_v44.z.object({
  ...
  performanceConfig: import_v44.z.object({ latency: import_v44.z.string() }).nullish(),
  serviceTier: import_v44.z.object({ type: import_v44.z.string() }).nullish(),
  usage: import_v44.z.object({
    ...
    cacheDetails: import_v44.z.array(import_v44.z.object({ inputTokens: import_v44.z.number(), ttl: import_v44.z.string() })).nullish()
  })
});
...
var amazonBedrockEmbeddingModelOptionsSchema = import_v45.z.object({
  /**
   ...
   */
  embeddingDimension: import_v45.z.union([import_v45.z.literal(256), import_v45.z.literal(384), import_v45.z.literal(1024), import_v45.z.literal(3072)]).optional(),
  /**
   * The purpose of the embedding. Defaults to 'GENERIC_INDEX'.
   * Only supported in amazon.nova-* embedding models.
   */
  embeddingPurpose: import_v45.z.enum([
    "GENERIC_INDEX",
    "TEXT_RETRIEVAL",
    "IMAGE_RETRIEVAL",
    "VIDEO_RETRIEVAL",
   ...
   */
  inputType: import_v45.z.enum(["search_document", "search_query", "classification", "clustering"]).optional(),
  /**
   ...
   */
  truncate: import_v45.z.enum(["NONE", "START", "END"]).optional(),
  /**
   ...
   */
  outputDimension: import_v45.z.union([import_v45.z.literal(256), import_v45.z.literal(512), import_v45.z.literal(1024), import_v45.z.literal(1536)]).optional()
});
...
var BedrockEmbeddingResponseSchema = import_v46.z.union([
  ...
  // Nova-style response
  import_v46.z.object({
    embeddings: import_v46.z.array(
      import_v46.z.object({
        embeddingType: import_v46.z.string(),
        embedding: import_v46.z.array(import_v46.z.number())
      })
    ),
    inputTokenCount: import_v46.z.number().optional()
  }),
  ...
  import_v46.z.object({
    embeddings: import_v46.z.object({
      float: import_v46.z.array(import_v46.z.array(import_v46.z.number()))
    })
  })
]);
...
var bedrockImageResponseSchema = import_v47.z.object({
  ...
  images: import_v47.z.array(import_v47.z.string()).optional(),
  // Moderation response fields
  id: import_v47.z.string().optional(),
  status: import_v47.z.string().optional(),
  result: import_v47.z.unknown().optional(),
  progress: import_v47.z.unknown().optional(),
  details: import_v47.z.record(import_v47.z.string(), import_v47.z.unknown()).optional(),
  preview: import_v47.z.unknown().optional()
});
  ...
  () => (0, import_provider_utils8.zodSchema)(
    import_v48.z.object({
      results: import_v48.z.array(
        import_v48.z.object({
          index: import_v48.z.number(),
          relevanceScore: import_v48.z.number()
        })
      ),
...
var amazonBedrockRerankingModelOptionsSchema = (0, import_provider_utils9.lazySchema)(
  () => (0, import_provider_utils9.zodSchema)(
    import_v49.z.object({
       ...
       */
      nextToken: import_v49.z.string().optional(),
      /**
       * Additional model request fields to pass to the model.
       */
      additionalModelRequestFields: import_v49.z.record(import_v49.z.string(), import_v49.z.any()).optional()
    })
  )
);
  ...
  const fetchFunction = apiKey ? createApiKeyFetchFunction(apiKey, options.fetch) : createSigV4FetchFunction(async () => {
    ...
    try {
      return {
        ...
        sessionToken: options.accessKeyId != null && options.secretAccessKey != null ? options.sessionToken : (0, import_provider_utils11.loadOptionalSetting)({

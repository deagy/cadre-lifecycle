...
function createVertexAnthropic(options = {}) {
  const getBaseURL = () => {
    ...
    return (_a = (0, import_provider_utils2.withoutTrailingSlash)(options.baseURL)) != null ? _a : `https://${getHost()}/v1/projects/${project}/locations/${location}/publishers/anthropic/models`;
  };

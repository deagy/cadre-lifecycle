...
// src/version.ts
var VERSION = true ? "4.0.172" : "0.0.0-test";
...
function convertFileToVertexImage(file, warnings) {
  ...
  const base64Data = typeof file.data === "string" ? file.data : (0, import_provider_utils5.convertUint8ArrayToBase64)(file.data);
  return {
...
var GoogleVertexVideoModel = class {
  ...
  async doGenerate(options) {
    ...
    } else if ((vertexOptions == null ? void 0 : vertexOptions.referenceImages) != null) {
    ...
    const generateAudio = (_d = options.generateAudio) != null ? _d : vertexOptions == null ? void 0 : vertexOptions.generateAudio;
    ...
    const pollIntervalMs = (_e = vertexOptions == null ? void 0 : vertexOptions.pollIntervalMs) != null ? _e : 1e4;
    const pollTimeoutMs = (_f = vertexOptions == null ? void 0 : vertexOptions.pollTimeoutMs) != null ? _f : 6e5;
...
function createVertex(options = {}) {
  ...
  const loadBaseURL = ({ endpoint = false } = {}) => {
    ...
    return (_b = (0, import_provider_utils6.withoutTrailingSlash)(options.baseURL)) != null ? _b : `https://${getHost()}/v1beta1/projects/${project}/locations/${region}${endpoint ? "" : "/publishers/google"}`;
  };
  ...
  const createInteractionsModel = (modelIdOrAgent) => {
    ...
    return new import_internal3.GoogleInteractionsLanguageModel(
      modelIdOrAgent,
      {

...
var mistralUsageSchema = import_v43.z.object({
  ...
  num_cached_tokens: import_v43.z.number().nullish(),
  prompt_tokens_details: import_v43.z.object({ cached_tokens: import_v43.z.number().nullish() }).nullish(),
  prompt_token_details: import_v43.z.object({ cached_tokens: import_v43.z.number().nullish() }).nullish()
});

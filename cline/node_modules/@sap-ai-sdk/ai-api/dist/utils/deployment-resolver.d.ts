 ...
 * @internal
 */
export declare function resolveDeploymentUrlById(deploymentId: string, resourceGroup: string, destination?: HttpDestinationOrFetchOptions): Promise<string>;
/**
 ...
 * @internal
 */
export declare function resolveDeploymentUrlForModel(modelDeployment: string | (DeploymentIdConfig | ModelConfig), options: Omit<DeploymentResolutionOptions, 'model'> & {
    resourceGroup: string;
}): Promise<string>;
/**
